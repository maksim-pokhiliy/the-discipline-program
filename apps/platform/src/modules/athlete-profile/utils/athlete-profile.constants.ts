...
export const ROLE_BADGE_BG_ALPHA = 0.12;
export const ROLE_BADGE_PADDING_Y_PX = 5;
export const ROLE_BADGE_PADDING_X_PX = 9;

export const TITLE_PX = 22;

export const EYEBROW_PX = 11;
export const EYEBROW_LETTER_SPACING = "0.06em";
...
export const ROLE_BADGE_LABEL = "Athlete";
...
export const BODY_WEIGHT_EMPTY_TITLE = "Not set";
export const BODY_WEIGHT_EMPTY_CAPTION =
...
export const PROFILE_PICKS_EYEBROW = "Training level";
export const PROFILE_PICKS_CAPTION =
  "Your coordinates on the loading grid. Every per-profile weight in your plans resolves through these picks — a change applies everywhere, immediately.";
...
export const PICK_OPTION_MIN_HEIGHT_PX = 48;
export const PICK_OPTION_LABEL_PX = 14;
export const PICK_TAG_PX = 10;
...
export const PICK_APPLYING_LABEL = "Applying…";
export const PICK_NOT_PICKED_LABEL = "Not picked";
export const PICK_NOT_PICKED_HELPER =
  "No pick yet — per-profile weights on this axis can't be resolved. Pick the cell that's yours.";
export const PICK_RETRY_LABEL = "Retry";

export const PICK_VALUE_MAX_CHARS = 28;
export const PICK_VALUE_ELLIPSIS = "…";
export const PICK_COORDINATE_SEPARATOR = " · ";
export const PICK_SENTENCE_END = ".";
export const PICK_APPLIED_PREFIX = "Applied — ";
export const PICK_APPLIED_RESOLVE_PREFIX = "training weights everywhere now resolve as ";
