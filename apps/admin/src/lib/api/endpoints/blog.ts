...
import { AdminBlogPageData, AdminBlogPost, BlogStats } from "@repo/api";
...
export const blogAPI = {
  ...
  create: (data: BlogPayload): Promise<AdminBlogPost> =>
    apiClient.request("/api/blog", "POST", data),
  update: (id: string, data: BlogPayload): Promise<AdminBlogPost> =>
