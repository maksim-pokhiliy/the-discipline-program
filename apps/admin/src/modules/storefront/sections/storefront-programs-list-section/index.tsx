...
import { useDeleteStorefrontProgram, useToggleStorefrontProgramStatus } from "@app/lib/hooks";
...
export const StorefrontProgramsListSection = ({ programs }: StorefrontProgramsListSectionProps) => {
  ...
  const columns: Column<StorefrontProgram>[] = [
    {
      id: "title",
      label: "Program Name",
      width: "35%",
  ...
  return (
    <>
      ...
      <ConfirmationModal
        ...
        details="This will remove the program from the marketing ftorefront immediately. This action cannot be undone."
        confirmText="Delete"
