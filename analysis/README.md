...
- **`artifacts/` — mixed; two layers live in most files:**
  ...
  - **The 34-archetype taxonomy is SUPERSEDED _as target design_** (`02-patterns/schema-archetypes.md` + mapping, `05-synthesis/`, `06-formalization/`). Kept as **evidence** (which structural shapes the primitives must express) and **history** — not deleted. Do not treat the archetype catalog here as the model to build.
...
Per-file audit 2026-06-02: zero garbage, nothing to delete. Active work: `initiatives/plan-editor-compose/`.
