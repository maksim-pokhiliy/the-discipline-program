...
| 1.2.G | —           | ⏳ Next | Extract blog reads from `cms/pages/public.ts` into new `cms/blog/public.ts` exposing `publicBlogApi`. Pages endpoint delegates instead of reading prisma directly. New finding from 1.2.C research. |
