...
8. **Coach is Sovereign**
   Тренер — единоличный владелец бизнеса, а не оператор с ограниченными правами.
   Никаких серверных блокировок на удаление планов, enrollment'ов или перемещение атлетов.
   Защита от случайных действий — через UI confirmation dialogs, не серверную валидацию.
   Stripe защищает покупателя на уровне платёжной системы (chargebacks, disputes).
