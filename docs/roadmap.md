...
| 4   | **Lifecycle email templates**                                     | ✅ **Complete.** Invite (works + tested), **lead-notify to the head coach** (#287), and the **password-reset email** (Resend, ships with #5) all fire.                                                                                                                                                                                                                                                                                                                                                                                                                           | infra                  |
| 5   | **Password reset / recovery**                                     | ✅ **Done (this PR).** A user recovers access via a self-service forgot-password flow — request by email (no enumeration) → hashed single-use 1h-TTL reset link → set a new password (old sessions killed) → sign in. Mirrors invite-token security mechanics; see `initiatives/pre-launch/password-reset-closeout.md`.                                                                                                                                                                                                                                                          | infra (auth)           |
