...
export const BLOCK_HR_Z2_RUN: CanonicalBlock = {
  ...
  schemas: [
    runDistance({
      order: 1,
      header: "Demo HR Z2 base run 60 min",
      rows: [
        mkRow(
          1,
...
export const BLOCK_NUMERIC_PACE_ROW: CanonicalBlock = {
  ...
  schemas: [
    runDistance({
      order: 1,
      header: "Demo Row intervals at numeric pace",
      rows: [
        mkRow(
          1,
...
export const BLOCK_TEMPO_BACK_SQUAT: CanonicalBlock = {
  ...
  schemas: [
    namedExerciseProgram({
      ...
      header: "Demo Tempo Back Squat 75% self",
      rows: [
        mkRow(
          1,
...
export const BLOCK_SNATCH_WAVE: CanonicalBlock = {
  ...
  schemas: [
    namedExerciseProgram({
      ...
      header: "Demo Snatch wave 70/80/90",
      rows: [
        mkRow(
          1,
...
export const BLOCK_PULL_UP_CLUSTER: CanonicalBlock = {
  ...
  schemas: [
    namedExerciseProgram({
      ...
      header: "Demo strict pull-up cluster 5 × (3+3+3)",
      rows: [
        mkRow(
          1,
...
export const BLOCK_SUPER_SET_PAIR_A: CanonicalBlock = {
  ...
  schemas: [
    superSet({
      ...
      pairs: [{ label: "Demo Pair A", schemaRows: [SUPER_PAIR_A, SUPER_PAIR_B] }],
      header: "Demo super-set A",
      rows: [
        mkRow(
          1,
