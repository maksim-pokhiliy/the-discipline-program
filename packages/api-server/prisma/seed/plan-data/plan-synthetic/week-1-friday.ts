    ...
    buildComposeNode(
      {
        ...
        header: "Power Set",
        rows: [
          mkRow(1, EX.powerClean, { load: absoluteLoad({ count: 1, kg: 70 }), reps: countReps(3) }),
        ],
      },
      rounds(5),
      null,
    ...
    buildComposeNode(
      {
        ...
        rows: [mkRow(1, EX.strictPullUp, { load: bodyweightLoad(), reps: countReps(5) })],
      },
      {},
      null,
    ),
...
const BLOCK_SINGLE_LINE_BARE_WK1_FRI: CanonicalBlock = {
  ...
  schemas: [
    buildComposeNode(
      {
        order: 1,
        rows: [mkRow(1, EX.barDip, { load: bodyweightLoad(), reps: countReps(10) })],
      },
      {},
      null,
    ),
...
const BLOCK_SINGLE_LINE_TOTAL_COUNTER_WK1_FRI: CanonicalBlock = {
  ...
  schemas: [
    buildComposeNode(
      {
        order: 1,
        rows: [mkRow(1, EX.strictHspu, { load: bodyweightLoad(), reps: countReps(30) })],
      },
      {},
      null,
    ),
    ...
    buildComposeNode(
      {
        order: 1,
        rows: [
          mkRow(1, EX.bandPullApart, { reps: countReps(20) }),
          mkRow(2, EX.plankHold, { reps: unitBoundReps({ unit: "sec", value: 30 }) }),
        ],
      },
      {},
      null,
    ...
    buildComposeNode(
      {
        ...
        rows: [
          ...
          mkRow(2, EX.boxJump, { load: bodyweightLoad(), reps: countReps(10) }),
        ],
      },
      cadenceRep(3, 5),
      null,
