...
| 1b  | **R1b — Clone editor-UX** (affordances + flows, `r1-clone-design.md`).                                       | owner browser walkthrough; **timed cycle beats Excel**                                                                                                          | 🟢 DONE — walkthrough passed (PR #274; D-8) |
| 2   | **P — Coach profile UI** — full vertical slice: schema-extended profile (D-7) + credentials + avatar upload. | profile round-trips; owner walkthrough + gated suite                                                                                                            | 🟢 MERGED (PR #273)                         |
