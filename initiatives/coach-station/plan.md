...
| #   | Step                                                                                                     | Gate                                                                                                                                                            | Status                   |
| --- | -------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------ |
| 1a  | **R1a — Clone server-engine** (deep-clone D-3 + 6 endpoints + gated tests).                              | deep-clone round-trips (structure + prescriptions + memberships + refs), atomic; gated api-server suite green on reseed (owner-run); Review B / QA B 0-CRITICAL | 🟢 built (gated PENDING) |
| 1b  | **R1b — Clone editor-UX** (affordances + flows, `r1-clone-design.md`).                                   | owner browser walkthrough; **timed cycle beats Excel**                                                                                                          | ⬜ next                  |
