...
`analysis/source/` (33 листа Дена) — расширенный корпус для того же теста на 10.1; Gauntlet — каноничный минимум.
...
1. **Expressiveness** — Денис собирает 3 злейших блока Gauntlet (B/C/D) свободным вложением. Канон — §3; расширение — `analysis/source/`.
