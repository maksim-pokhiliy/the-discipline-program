...
| 1   | **Reshape** — ONE `/feature` (full) | #3,#4,#6,#12,#16,#17 | ✅ SHIPPED 2026-06-17 — 94 files, gates green (contracts 781 / platform 947), spec re-frozen, in the feature PR. Owner acceptance owed (db:reset + api-server suite + walkthrough). |
