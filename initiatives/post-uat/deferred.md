...
- **TikTok link (UAT chat 18.07).** OPEN — content unknown; ask the owner what it referenced (suspected: a timer UI reference for PU-12). Resolve before the W5 design pass.
