...
| W3  | Editor remap onto the Group model (proto fidelity, gesture set, draft collapse)                        | — (rides W2)               | round-trips + walkthrough of the full gesture set                  | 🟢 built on branch  |
...
## W3 — editor remap (BUILT on branch 2026-06-12 — `feat/session-primitive-w3-editor-remap`, 10 commits, gates green; DR-W3-1..10)
